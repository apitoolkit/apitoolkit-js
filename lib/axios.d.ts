...
export declare function observeAxiosGlobal(axiosInstance: AxiosInstance, urlWildcard?: string | undefined, redactHeaders?: string[], redactRequestBody?: string[], redactResponseBody?: string[], notWebContext?: boolean | undefined, client?: any): void;
