...
exports.buildPayload =
  exports.observeAxios =
  exports.onResponseError =
  exports.onResponse =
...
const onResponse =
  (urlWildcard, redactHeaderLists, redactRequestBody, redactResponseBody) =>
  (response) => {
    if (apitoolkit_1.asyncLocalStorage.getStore() == null) {
      console.log(
    ...
    const project_id = apitoolkit_1.asyncLocalStorage
      .getStore()
      .get("AT_project_id");
...
function observeAxios(
  ...
  axiosInstance.interceptors.response.use(
    (0, exports.onResponse)(
      urlWildcard,
      redactHeaders,
      redactRequestBody,
      redactResponseBody
    ),
    (0, exports.onResponseError)(
      urlWildcard,
      redactHeaders,
      redactRequestBody,
      redactResponseBody
...
function buildPayload(
  ...
  const payload = {
    ...
    request_body: Buffer.from(
      (0, payload_1.redactFields)(reqBody, redactRequestBody)
    ).toString("base64"),
    request_headers: (0, payload_1.redactHeaders)(
      reqHeaders,
      redactHeaderLists
    ),
    response_body: Buffer.from(
      (0, payload_1.redactFields)(respBody, redactResponseBody)
    ).toString("base64"),
    response_headers: (0, payload_1.redactHeaders)(
      resHeaders,
      redactHeaderLists
    ),
