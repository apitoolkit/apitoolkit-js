...
function observeAxios(axiosInstance, urlWildcard = undefined, redactHeaders = [], redactRequestBody = [], redactResponseBody = [], notWebContext = false, client = undefined) {
    ...
    newAxios.interceptors.response.use((0, exports.onResponse)(urlWildcard, redactHeaders, redactRequestBody, redactResponseBody, !!notWebContext, client), (0, exports.onResponseError)(urlWildcard, redactHeaders, redactRequestBody, redactResponseBody, !!notWebContext, client));
    return newAxios;
}
